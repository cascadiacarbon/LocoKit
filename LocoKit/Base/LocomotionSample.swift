...
open class LocomotionSample: ActivityTypeTrainable, Codable {
    ...
    public func toDictionary() -> NSDictionary {
        ...
        //NSLog("%@", _classifiedType);
        dictionary.setValue(activityType, forKey: "activity");
        NSLog("%@", location!);
        ...
        */
        ...
        let locationArrayUnmutable: NSArray = locationArray.copy() as! NSArray;
       // dictionary.setValue(locationArrayUnmutable, forKey: "filteredLocations");
        NSLog("Locations: %@", locationArrayUnmutable);
        
        let dictionary : NSDictionary = ["activity" : activityType, "location" : location, "timestamp" : timestamp, "filteredLocations" : locationArrayUnmutable];
